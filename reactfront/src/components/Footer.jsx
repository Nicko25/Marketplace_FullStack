  ...
  return (
    <Container>
      <Left>
        <Logo>MdPP.</Logo>
        <Desc>
        Nuestra misión es crear nuevas posibilidades para cualquier persona.
        Nuestra tienda virtual ofrece una amplia biblioteca que incluye miles de cursos impartidos por profesores del mundo real.
        </Desc>
        <SocialContainer>
